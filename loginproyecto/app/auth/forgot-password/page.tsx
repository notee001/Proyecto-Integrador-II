    ...
    <div className="flex min-h-svh w-full items-center justify-center p-6 md:p-10 bg-gradient-to-b from-green-50 to-green-100 relative">
      ...
      <div className="w-full max-w-sm z-10">
        <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-xl p-8 border border-green-100">
          <h1 className="text-2xl font-bold text-green-800 mb-6 text-center">Recupera tu contraseña</h1>
          <p className="text-green-600 text-center mb-6">Te enviaremos un correo con instrucciones para restablecer tu contraseña</p>
          <ForgotPasswordForm />
        </div>
      </div>
    </div>
